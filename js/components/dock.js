...
<div id="persistent-dock" 
     class="fixed bottom-4 left-4 right-4 h-16 bg-white/85 dark:bg-slate-900/85 backdrop-blur-xl rounded-3xl border border-slate-200/60 dark:border-slate-800 shadow-2xl z-40 transition-transform duration-300 ease-in-out flex items-center justify-around px-2 max-w-md mx-auto transform translate-y-0">
  
  <!-- 1. Credentials (CAAM + MAB Folder Tabs) -->
  <button id="dock-creds-btn" class="flex flex-col items-center gap-1 text-blue-600 dark:text-blue-400 p-2 active:scale-95 transition-transform">
  ...
  <!-- 2. History Shortcut -->
  <button id="dock-history-btn" class="flex flex-col items-center gap-1 text-slate-500 dark:text-slate-400 p-2 active:scale-95 transition-transform">
    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
  ...
  <button id="dock-tools-btn" class="flex flex-col items-center gap-1 text-slate-500 dark:text-slate-400 p-2 active:scale-95 transition-transform">
    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
  ...
  <!-- 4. Main Menu Toggle -->
  <button id="dock-menu-btn" class="flex flex-col items-center gap-1 text-slate-500 dark:text-slate-400 p-2 active:scale-95 transition-transform">
    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
