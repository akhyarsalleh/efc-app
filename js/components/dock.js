...
<div id="persistent-dock" 
  ...
  <div class="max-w-md mx-auto h-full grid grid-cols-5 items-center justify-items-center px-1">
    ...
    <!-- 3. CENTER HERO SCAN BUTTON -->
    <button id="dock-scan-btn" class="flex flex-col items-center justify-center -mt-4 bg-blue-600 dark:bg-blue-500 text-white w-12 h-12 rounded-full shadow-lg border-2 border-white dark:border-slate-900 active:scale-90 transition-transform">
