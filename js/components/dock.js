...
<div id="persistent-dock" 
  ...
  <div class="max-w-md mx-auto h-full grid grid-cols-5 items-center justify-items-center px-1">
    ...
    <!-- 3. CENTER SUBTLE BUTTON: SCAN -->
    <button id="dock-scan-btn" class="flex flex-col items-center justify-center gap-1 text-blue-600 dark:text-blue-400 bg-blue-50/80 dark:bg-blue-950/50 border border-blue-200/50 dark:border-blue-800/50 px-2 py-1 rounded-xl active:scale-95 transition-all w-[88%] my-auto">
      <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
