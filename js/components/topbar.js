...
<div id="persistent-topbar" 
  ...
  <div class="max-w-md mx-auto h-full flex items-center justify-between px-3">
    ...
    <div class="flex items-center border border-white/20 rounded-lg overflow-hidden h-8">
      <!-- Text Size Toggle with New A-a Caret SVG -->
      <button id="topbar-text-btn" 
              class="p-2 hover:bg-white/10 active:bg-white/20 transition-colors border-r border-white/20 flex items-center justify-center cursor-pointer" 
      ...
      <button id="topbar-theme-btn" 
              class="p-2 hover:bg-white/10 active:bg-white/20 transition-colors flex items-center justify-center cursor-pointer" 
